    ...
    <div className="min-h-screen bg-gray-900 flex flex-col items-center px-6 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-6xl w-full">
        {courseList.map((course, index) => (
          ...
          >
            ...
            <p className="text-gray-300">{course.short}</p>
          </div>
        ))}
      </div>
      ...
      {selectedCourse && (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center px-4">
          <div className="bg-white max-w-lg w-full rounded-lg shadow-2xl p-6 relative max-h-[90vh] overflow-hidden">
            <button
            ...
            <div className="overflow-y-auto pr-2 max-h-[65vh] custom-scroll">
